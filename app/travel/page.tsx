            ...
            <div className="space-y-16">
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-zinc-50 dark:bg-zinc-900/50 p-6 rounded-sm border border-zinc-100 dark:border-zinc-800 flex flex-col h-full">
                            <h3 className="text-xl font-sans mb-3 flex-shrink-0">Taxis</h3>
                            <p className="text-zinc-600 dark:text-zinc-400 font-karla text-base mb-2 flex-grow">
                            ...
                            <p className="text-red-600 dark:text-red-400 font-karla text-sm mt-4 shrink-0">
                        ...
                        <div className="bg-zinc-50 dark:bg-zinc-900/50 p-6 rounded-sm border border-zinc-100 dark:border-zinc-800 flex flex-col h-full">
                            ...
                            <div className="flex-grow">
                                <p className="text-zinc-600 dark:text-zinc-400 font-karla text-base mb-4">
                                ...
                                <ol className="list-decimal list-inside space-y-2 text-zinc-600 dark:text-zinc-400 font-karla text-sm mb-6 ml-2">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-full bg-black text-white dark:bg-white dark:text-black py-3 px-4 rounded-sm text-center font-sans tracking-wide uppercase text-xs hover:bg-sage dark:hover:bg-sage hover:text-white transition-colors duration-300 mt-auto shrink-0"
                            >
                        ...
                        <div className="bg-zinc-50 dark:bg-zinc-900/50 p-6 rounded-sm border border-zinc-100 dark:border-zinc-800 flex flex-col h-full">
                            ...
                            <p className="text-zinc-600 dark:text-zinc-400 font-karla text-base italic flex-grow">
                        ...
                        <div className="bg-sage/10 p-6 rounded-sm border border-sage/30 flex flex-col h-full">
                            ...
                            <p className="text-zinc-700 dark:text-zinc-300 font-karla text-base flex-grow">
